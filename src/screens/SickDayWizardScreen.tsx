...
const styles = StyleSheet.create({
  ...
  stepNumInactive: { color: '#5f6368', fontWeight: '700', fontSize: 16 },
  ...
  nauseaText: { fontSize: 13, color: '#ea4335', fontWeight: '600' },
  glucoseInput: { backgroundColor: '#fff', borderRadius: 10, padding: 14, fontSize: 28, fontWeight: '700', borderWidth: 1, borderColor: '#dadce0', textAlign: 'center' },
  ...
  toggleText: { fontSize: 16, fontWeight: '600', color: '#3c4043' },
  ...
  warningText: { fontSize: 13, color: '#e37400' },
  ...
  emergencyTitle: { fontSize: 20, fontWeight: '800', color: '#ea4335', marginBottom: 8 },
  emergencyText: { fontSize: 15, fontWeight: '600', color: '#202124', marginBottom: 4 },
  redFlagItem: { fontSize: 14, color: '#ea4335', fontWeight: '600', paddingVertical: 2 },
  guidanceCard: { backgroundColor: '#fff', borderRadius: 12, padding: 18, marginBottom: 14, borderWidth: 1, borderColor: '#e8eaed' },
  guidanceTitle: { fontSize: 18, fontWeight: '700', color: '#202124', marginBottom: 14 },
  guidanceSection: { marginBottom: 16 },
  guidanceLabel: { fontSize: 15, fontWeight: '700', color: '#202124', marginBottom: 6 },
  guidanceText: { fontSize: 14, color: '#5f6368', paddingVertical: 2 },
  doseText: { fontSize: 18, fontWeight: '700', color: '#1a73e8', marginTop: 4 },
  ...
  glucagonDose: { fontSize: 14, fontWeight: '600', color: '#202124' },
  disclaimerSmall: { fontSize: 11, color: '#5f6368', marginBottom: 8, fontStyle: 'italic' },
  smallDisclaimer: { textAlign: 'center', color: '#5f6368', fontSize: 11, marginTop: 10, paddingHorizontal: 12 },
  ...
  ketonePromptTitle: { fontSize: 15, fontWeight: '700', color: '#1a73e8', marginBottom: 6 },
  ketonePromptText: { fontSize: 13, color: '#1a73e8', lineHeight: 18 },
});
