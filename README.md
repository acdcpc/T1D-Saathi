...
- 🍽️ **Food Estimator**: Photo recognition is safety-disabled in the mobile client until a privacy-reviewed server endpoint is configured. Manual Nepali-food entry remains available; no provider secret belongs in the app bundle.
